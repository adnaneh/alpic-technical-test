...
import { z } from "zod";
import { ListChaptersParams, GetChapterAudioParams } from "./library.schemas";
...
export class LibraryService {
  ...
  @Tool({
    ...
    description:
      "Get the audio URL and timing information for a specific chapter",
